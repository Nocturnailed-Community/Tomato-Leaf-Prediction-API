...
def predict_top_2_classes(img_path):
    ...
    try:
        ...
        top_2_predictions = [{"label": dic[i], "percentage": float(round(prediction[i], 2))} for i in top_2_indices]
...
def upload():
    ...
    try:
        ...
        # Handle prediction results
        top_prediction_label = top_2_predictions[0]['label']
        top_prediction_percentage = top_2_predictions[0]['percentage']
        second_prediction_label = top_2_predictions[1]['label']
        second_prediction_percentage = top_2_predictions[1]['percentage']
        ...
        if top_prediction_percentage < 85 and second_prediction_percentage < 85:
            return jsonify({
                'PredictionLabel': 'Daun penyakit tidak ditemukan', 
